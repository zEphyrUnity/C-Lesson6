...
class Program
{
    //Структура с тремя полями для сортировки. Подключен интерфейс IComparable, реализован метод сравнения CompareTo для одного поля
    ...
    //Метод сравнения для двух полей
    ...
    static void Main(string[] args)
    {
        ...
        while (!sr.EndOfStream)
        {
            try
            {
                ...
                //Подсчет количества студентов 5го и 6го курса
                if (Int32.Parse(s[6]) >= 5) seniorCourse++;

                //Поиск студентов от 18 до 20 лет по курсам
        ...
        Console.WriteLine($"Старшекурсников:{seniorCourse}");            // Количество студентов 5го и 6го курса
